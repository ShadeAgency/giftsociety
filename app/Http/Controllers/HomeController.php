...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $trending_product = Cache::rememberForever('trending_product', function () {
            return filter_products(Product::where('published', 1)->where('tranding', '1'))->get();
        });
        ...
        return view('frontend.index', compact('featured_categories', 'todays_deal_products', 'newest_products','trending_product'));
    }
    ...
    public function loginmobile(Request $request){
        ini_set('memory_limit','-1');
        $user = User::where('otpcode', $request->otp)->first();
        $path_details = !empty($request->path_text)?$request->path_text:'';
        // Check Condition Mobile No. Found or Not
        if($user==null) {
           flash(translate('Please enter correct otpcode!'))->warning();
            return back();
        }        
