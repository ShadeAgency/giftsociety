...
@section('content')
{{-- <?php dd($products); ?> --}}
    <section class="pt-3 bg-white pb-4">
        <div class="container-fluid sm-px-0">
            <form class="" id="search-form" action="" method="GET">
                <div class="row">
                    <div class="col-md-12">
                         <ul class="breadcrumb bg-transparent pb-4 d-flex justify-content-end border-bottom">
                            <li class="breadcrumb-item opacity-50">
                                <a class="text-reset" href="{{ route('home') }}">{{ translate('Home')}}</a>
                            </li>
                            @if(!isset($category_id))
                                <li class="breadcrumb-item fw-600  text-dark">
                                    <a class="text-reset head_top p-2" href="{{ route('search') }}">"{{ translate('All Categories')}}"</a>
                                </li>
                            @else
                                <li class="breadcrumb-item opacity-50">
                            ...
                            @if(isset($category_id))
                                <li class="text-dark fw-600 breadcrumb-item ">
                                    <a class="text-reset p-2 head_top" href="{{ route('products.category', \App\Models\Category::find($category_id)->slug) }}">"{{ \App\Models\Category::find($category_id)->getTranslation('name') }}"</a>
                                </li>
                            @endif
                        </ul>
                    </div>
                    <div class="col-xl-3">
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035 border-right pr-2">
                    ...
                    <div class="col-xl-9">
                        <div class="text-left">
                            <div class="row gutters-5 flex-wrap align-items-center head_top1">
                                <div class="col-lg col-10">
                                    <h1 class=" fw-600 text-body">
                                        @if(isset($category_id))
                                            {{ \App\Models\Category::find($category_id)->getTranslation('name') }} <span class="fs-20 fw-400">({{count($products)}})</span>
                                        @elseif(isset($query))
                                            {{ translate('Search result for ') }}"{{ $query }}"
                                        @else
                                            {{ translate('All Products') }}  <span class="fs-20 fw-400">({{count($products)}})</span>
                                        @endif
                                    </h1>
