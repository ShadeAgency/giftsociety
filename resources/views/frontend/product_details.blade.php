...
@section('content')
    <section class="mb-4 pt-3 bg-white">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                           ...
                           <div class="row align-items-center">
                            ...
                            @else
                                @if (home_price($detailedProduct) != home_discounted_price($detailedProduct))
                                    <div class="row no-gutters mt-3">
                                        <div class="col-sm-12">
                                            <div class=" my-2 fw-700 fs-15">{{ translate('Price') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row no-gutters my-2">
                                        <div class="col-sm-12">
                                            <div class=" my-2 fw-700 fs-15">{{ translate('Discount Price') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="">
                            ...
                            @if (addon_is_activated('club_point') && $detailedProduct->earn_point > 0)
                                <div class="row no-gutters mt-4">
                                    <div class="col-sm-12">
                                        <div class=" my-2 fw-700 fs-15">{{ translate('Club Point') }}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                        <div
                            ...
                            <form id="option-choice-form">
                                ...
                                @if (count(json_decode($detailedProduct->colors)) > 0)
                                    <div class="row no-gutters">
                                        <div class="col-sm-12">
                                            <div class=" my-2 fw-700 fs-15">{{ translate('Color') }}:</div>
                                        </div>
                                        <div class="col-sm-10">
                                            <div class="aiz-radio-inline">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-12">
                                        <div class=" my-2 fw-700 fs-15">{{ translate('Quantity') }}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-12">
                                        <div class=" my-2 fw-700 fs-15">{{ translate('Pincode') }}:</div>
                                    </div>
                                    <div class="col-sm-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <input class="form-control w-50" type="text" placeholder="Pincode" value="" name="" id="pincode">
                                        </div>
                                    </div>
                                </div>
                               ...
                               <div class="row no-gutters pb-3 " >
                                    <div class="col-sm-12">
                                        <div class=" my-2 fw-700 fs-15">{{ translate('Description') }}:</div>
                                    </div>
                                    
                                    <div class="col-sm-10">
                                      
                                      {!! translate($detailedProduct->short) !!}
                            ...
                            <div class="mt-3">
                                ...
                                @else
                                    <button type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600"
                                        onclick="addToCart()" style="width:40%">
                                        <i class="las la-shopping-bag"></i>
                                        <span class="d-none d-md-inline-block"> {{ translate('Add to cart') }}</span>
                                    </button>
                                    <button type="button" class="btn btn-primary buy-now fw-600" onclick="buyNow()" style="width:40%">
                            ...
                            @if (addon_is_activated('refund_request'))
                                <div class="row no-gutters mt-3">
                                    <div class="col-12">
                                        <div class=" my-2 fw-700 fs-15">{{ translate('Refund') }}:</div>
                                    </div>
                                    <div class="col-10">
                           ...
                           {{-- <div class="row no-gutters mt-4">
                                <div class="col-sm-12">
                                    <div class=" my-2 fw-700 fs-15">{{ translate('Share') }}:</div>
                                </div>
                                <div class="col-sm-10">
...
<!--                    <span class="mr-4">{{ translate('What customers are saying') }}</span>-->
<!--                </h3>-->
<!--            </div>-->
<!--            <div class="p-3">-->
...
<!--                                            <del-->
<!--                                                class="fw-600 opacity-50 mr-1"></del>-->
                                       
<!--                                        <span-->
<!--                                            class="fw-700 text-primary"></span>-->
<!--                                    </div>-->
...
<!--</section>-->
    <section class="mb-4">
        <div class="container-fluid">
            <div class="row gutters-10">
                <div class="col-md-12 order-1 order-xl-0">
                                        ...
                                        <div
                                            ...
                                            <div class="">
                                                <a href="{{ route('product', $top_product->slug) }}"
                                                    ...
                                                    <img class="img-fit h-140px h-lg-210px ls-is-cached lazyloaded"
                                                        src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                            ...
                                            <div class="p-md-3 p-2 text-left">
                                                <h4 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                                    <a href="{{ route('product', $top_product->slug) }}"
...
<section class="mb-4">
 ...
 <div class="container-fluid" style="display: flex;background: linear-gradient(to right,#49586e,#94a3b8);align-items: center;height: 12.83vw;">
        <div class="row" style=" background-image: url('https://cdn.igp.com/f_auto,q_auto/banners/Desktop_Newsletter.png');background-size: 100% 100%;
width: 100%;
height: 100%;">
            <div class="col-md-6" style="padding: 50px;">
                <h4 class="header text-white">Newsletter updates!!</h4>
                <span class="text text-white fs-18">Get unique &amp; trendy gift ideas and best offers delivered to your inbox.</span>
            </div>
