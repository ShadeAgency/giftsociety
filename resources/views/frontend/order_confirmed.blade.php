    ...
    <div class="container text-center">
        <div class="row">
              <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4">{{translate(' Confirmation') }}</h1>
            </div>
            <div class="col-lg-6">
...
justify-content: center;display: flex;align-items: center;width: 100%;">"{{translate(' Confirmation') }}"</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class="py-4 pt-4 bg-white">
