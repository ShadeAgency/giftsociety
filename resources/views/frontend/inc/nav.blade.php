...
@endif
<!-- Top Bar -->
<div class="top-navbar bg-white border-bottom border-soft-secondary z-1035 h-35px h-sm-auto nav_back">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col text-right">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-end mb-0">
...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 bg-white border-bottom shadow-sm">
    <div class="position-relative logo-bar-area z-1">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-1 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block  mr-3 ml-0" href="{{ route('home') }}">
                        @php
                            $header_logo = get_setting('header_logo');
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-85px h-md-85px" height="80">
                        @else
                            <img src="https://thegiftsociety.in/wp-content/uploads/2022/03/u.png" alt="{{ env('APP_NAME') }}" class="mw-100 h-85px h-md-85px" height="85">
                ...
                <div class="flex-grow-1 front-header-search d-flex align-items-center bg-white">
                    <div class="position-relative flex-grow-1">
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            <div class="d-flex position-relative align-items-center" style="border: 1px solid #f4f4f7;border-radius: 49px;">
                                <div class="d-lg-none" data-toggle="class-toggle" data-target=".front-header-search">
                                    <button class="btn " type="button"><i class="la la-2x la-long-arrow-left"></i></button>
                                </div>
                ...
                <div class="col-xl-2 d-lg-block d-none">
                     <a href="{{ route('orders.track') }}"  class="btn btn-primary fs-13">
           ...
           <div class="col-xl-3 text-right d-none d-lg-block">
                ...
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    @if (get_setting('helpline_number'))
                        <li class="list-inline-item mr-3 border-right border-left-0 w-100 pr-3">
                            <a href="tel:{{ get_setting('helpline_number') }}" class="text-reset d-inline-block py-2">
                                <i class="la la-phone"></i>
                                <span>{{ translate('Help line')}}</span>  
                                <span>{{ get_setting('helpline_number') }}</span>    
                  ...
                  <div class="dropdown-content">
                    @auth
                        @if(isAdmin())
                            <li class="list-inline-item mr-3 border-right border-left-0 w-100 border-bottom">
                                <a href="{{ route('admin.dashboard') }}" class="text-reset d-inline-block py-2">{{ translate('My Panel')}}</a>
                            </li>
                        @else

                            <li class="list-inline-item mr-3 border-right border-left-0 w-100 dropdown border-bottom">
                                <a class="dropdown-toggle no-arrow text-reset" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                                    <span class="">
                                        <span class="position-relative d-inline-block">
                                            <i class="las la-bell fs-18"></i>
                        ...
                        @endif
                        <li class="list-inline-item w-100 border-bottom">
                            <a href="{{ route('logout') }}" class="text-reset d-inline-block py-2">{{ translate('Logout')}}</a>
                        </li>
                    @else
                        <li class="list-inline-item mr-3 border-right border-left-0 w-100 border-bottom">
        ...
        @if(Route::currentRouteName() != 'home')
        <div class="hover-category-menu position-absolute w-100 top-100 left-0 right-0 d-none z-3" id="hover-category-menu" style="display:none;">
            <div class="container">
    ...
    <style>
     ...
     <div class="bg-white border-top border-gray-200 py-1 d-none d-lg-block">
            <div class="container" style="align-items: center;display: flex !important;">
               <div class="aiz-category-menu" id="category-sidebar">
                <ul class="list-unstyled d-flex m-0">
                    <li class="category-nav-element">
                            <a href="http://giftsociety.shadecrm.com/" class="text-truncate text-reset py-2 px-3 d-block fw-500 fs-14">
                    ...
                    @foreach (\App\Models\Category::where('level', 0)->orderBy('order_level', 'desc')->get()->take(11) as $key => $category)
                        <li class="category-nav-element" data-id="{{ $category->id }}">
                            <a href="{{ route('products.category', $category->slug) }}" class="text-truncate text-reset py-2 px-3 d-block fw-500 fs-14">
