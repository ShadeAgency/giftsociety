        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="list-unstyled">
                   <li class="mb-2"> BEAUTY : Face Care | Kajal Makeup | Nail Care | Foundation Eye care | Lipsticks | Face Mask | Face Cream | Facial Kit | Hair Care | Fragrances</li>
                   <li class="mb-2">BEAUTY : Face Care | Kajal Makeup | Nail Care | Foundation Eye care | Lipsticks | Face Mask | Face Cream | Facial Kit | Hair Care | Fragrances | Facial Kit | Hair Care | Fragrances</li>
                   <li class="mb-2">BEAUTY : Face Care | Kajal Makeup | Nail Care | Foundation Eye care | Lipsticks | Face Mask | Face Cream | Facial Kit | Hair Care | Fragrances | Facial Kit | Hair Care | Fragrances</li>
                   <li class="mb-2">BEAUTY : Face Care | Kajal Makeup | Nail Care | Foundation Eye care | Lipsticks | Face Mask | Face Cream | Facial Kit | Hair Care | Fragrances | Facial Kit | Hair Care | Fragrances</li>
                   <li class="mb-2">BEAUTY : Face Care | Kajal Makeup | Nail Care | Foundation Eye care | Lipsticks | Face Mask | Face Cream | Facial Kit | Hair Care | Fragrances | Facial Kit | Hair Care | Fragrances</li>
                   <li class="mb-2">BEAUTY : Face Care | Kajal Makeup | Nail Care | Foundation Eye care | Lipsticks | Face Mask | Face Cream | Facial Kit | Hair Care | Fragrances | Facial Kit | Hair Care | Fragrances </li>
          ...
          {{--  <div class="col-lg-5 col-xl-4 text-center text-md-left">
            ...
            <div class="col-lg-3 col-md-3">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-17 text-uppercase fw-700 border-bottom border-gray-900 pb-2 mb-4">
                        {{ get_setting('widget_one',null,App::getLocale()) }}
                    </h4>
                    <ul class="list-unstyled">
                         <li class="mb-2">
                                <a href="http://giftsociety.shadecrm.com/contact_us" class="fs-15 hov-opacity-100 text-reset">
                                    Contact Us
                            </li>
                        @if ( get_setting('widget_one_labels',null,App::getLocale()) !=  null )
                            @foreach (json_decode( get_setting('widget_one_labels',null,App::getLocale()), true) as $key => $value)
                            <li class="mb-2">
                                <a href="{{ json_decode( get_setting('widget_one_links'), true)[$key] }}" class="fs-15 hov-opacity-100 text-reset">
                                    {{ $value }}
                                </a>
                            </li>
                            @endforeach
                        ...
                        <a href="{{ route('shops.create') }}" class="fs-15 hov-opacity-100 text-reset">
            ...
            <div class="col-md-3 col-lg-3">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        @if (Auth::check())
                            <li class="mb-2">
                                <a class="fs-15 hov-opacity-100 text-reset" href="{{ route('logout') }}">
                                    {{ translate('Logout') }}
                                </a>
                            </li>
                        @else
                            <li class="mb-2">
                                <a class="fs-15 hov-opacity-100 text-reset" href="{{ route('user.login') }}">
                                    {{ translate('Login') }}
                                </a>
                            </li>
                        @endif
                        <li class="mb-2">
                            <a class="fs-15 hov-opacity-100 text-reset" href="{{ route('purchase_history.index') }}">
                                {{ translate('Order History') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a class="fs-15 hov-opacity-100 text-reset" href="{{ route('wishlists.index') }}">
                                {{ translate('My Wishlist') }}
                            </a>
                        </li>
                        <li class="mb-2">
                            <a class="fs-15 hov-opacity-100 text-reset" href="{{ route('orders.track') }}">
                                {{ translate('Track Order') }}
                            </a>
                        </li>
                        @if (addon_is_activated('affiliate_system'))
                            <li class="mb-2">
                                <a class="fs-15 hov-opacity-100 text-light" href="{{ route('affiliate.apply') }}">{{ translate('Be an affiliate partner')}}</a>
                            </li>
                        @endif
                    </ul>
                </div>
            ...
            <div class="col-lg-3 col-md-3">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-17 text-uppercase fw-700 border-bottom border-gray-900 pb-2 mb-4">
                        {{ get_setting('widget_one1',null,App::getLocale()) }}
                    </h4>
                    <ul class="list-unstyled">
                        @if ( get_setting('widget_one_labels1',null,App::getLocale()) !=  null )
                            @foreach (json_decode( get_setting('widget_one_labels1',null,App::getLocale()), true) as $key => $value)
                            <li class="mb-2">
                                <a href="{{ json_decode( get_setting('widget_one_links1'), true)[$key] }}" class="fs-15 hov-opacity-100 text-reset">
                                    {{ $value }}
                                </a>
                            </li>
                            @endforeach
            ...
            <div class="col-lg-3 col-md-3 mr-0">
                <div class="text-center text-md-left mt-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2">
                           <!--<span class="d-block opacity-50 fs-14">{{ translate('Address') }}:</span>-->
                           <span class="d-block fs-15">{{ get_setting('contact_address',null,App::getLocale()) }}</span>
                        </li>
                        <li class="mb-2">
                           <!--<span class="d-block opacity-50 fs-14">{{translate('Phone')}}:</span>-->
                           <span class="d-block fs-15">{{translate('Phone')}}:  {{ get_setting('contact_phone') }}</span>
                        </li>
                        <li class="mb-2">
                           <!--<span class="d-block opacity-50 fs-14">{{translate('Email')}}:</span>-->
                           <span class="d-block fs-15">
                               <a href="mailto:{{ get_setting('contact_email') }}" class="text-reset">{{translate('Email')}}:  {{ get_setting('contact_email')  }}</a>
                            </span>
                        </li>
                    </ul>
                </div>
            ...
            <div class="col-md-12 text-center mt-4">
                 <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="84">
                        @else
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="84">
                        @endif
                    </a>
            </div>
            <div class="col-md-12 text-center mt-4">
