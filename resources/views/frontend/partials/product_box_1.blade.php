<div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white" style="box-shadow: -5px 5px 5px 5px #f2f2f2;
padding: 4px;">
  {{-- @if(discount_in_percentage($product) > 0)
    ...
    <div class="p-md-3 p-2 text-left">
        ...
        <div class="fs-15">
          ...
          @if(discount_in_percentage($product) > 0)
        <span class="fs-13">{{ translate('OFF') }}<span class="box ml-1 mr-0">&nbsp;{{discount_in_percentage($product)}}%</span></span>
    @endif
