    ...
    <div class="container text-center">
        <div class="row">
              <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4">{{translate(' Payment') }}</h1>
            </div>
            <div class="col-lg-6">
...
justify-content: center;display: flex;align-items: center;width: 100%;">"{{translate(' Payment') }}"</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <div class="row align-items-center pt-3">
                            ...
                            <div class="col-6 text-right">
                                <button type="button" onclick="submitOrder(this)"
                                    class="btn btn-primary fw-600 w-100">{{ translate('Complete Order') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
