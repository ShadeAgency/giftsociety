    ...
    <div class="container text-center">
        <div class="row">
              <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4">{{translate('Cart') }}</h1>
            </div>
            <div class="col-lg-6">
...
justify-content: center;display: flex;align-items: center;width: 100%;">"{{translate('Cart') }}"</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <section class=" pt-5 bg-white" id="cart-summary">
        <div class="container">
            @if ($carts && count($carts) > 0)
                <div class="row">
                    <div class="col-xxl-8 col-xl-10 mx-auto ">
                        <div class="shadow mb-5 bg-white rounded text-left p-3">
                            <div class="mb-4">
                                <div class="row gutters-5 d-none d-lg-flex border-bottom mb-3 pb-3 rounded pt-3 " style="background: #800080 !important;color: white !important;font-size: 15px;">
                            ...
                            <div class="px-3 py-2 mb-4 border-top d-flex justify-content-between border-bottom">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12 text-center text-md-right">
                                    @if (Auth::check())
                                        <a href="{{ route('checkout.shipping_info') }}" class="btn btn-primary fw-600 w-100">
                                            {{ translate('Continue to Shipping') }}
                                        </a>
                                    @else
                                        <button class="btn btn-primary fw-600 w-100"
                                            onclick="showCheckoutModal()">{{ translate('Continue to Shipping') }}</button>
                                    @endif
                                </div>
                                <div class="col-md-12 text-center text-md-left order-1 order-md-0">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                            ...
                            <div class="mb-5">
                                <button type="submit"
                                    class="btn btn-primary btn-block fw-600">{{ translate('Guest Checkout') }}</button>
                            </div>
                        </form>
