    ...
    <div class="container text-center">
        <div class="row">
              <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4">{{translate('Delivery info') }}</h1>
            </div>
            <div class="col-lg-6">
...
justify-content: center;display: flex;align-items: center;width: 100%;">"{{translate('Delivery info') }}"</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="col-md-8 mx-auto">
                <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                    ...
                    <div class="card mb-3 shadow border-0 rounded">
                        <div class="card-header p-3" style="background: #800080;color: white;font-size: 15px;">
                    ...
                    <div class="pt-4 d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn fw-600 btn-primary w-50">{{ translate('Continue to Payment')}}</button>
                    </div>
                </form>
            </div>
