    ...
    <div class="row align-items-center m-1">
        @can('Create Expense')
            <div class="col-auto pe-0">
                <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Expense')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Expense')}}" data-url="{{route('expenses.create')}}"><i class="ti ti-plus text-white"></i></a>
            </div>
        @endcan
    </div>
@endsection
                            ...
                            <table class="table pc-dt-simple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if(isset($expense->deal) && !empty($expense->deal)) {{ $expense->deal->name }} @else - @endif</td>
                                        ...
                                        <td class="Action">
                                            ...
                                            @can('Edit Expense')
                                                <div class="action-btn btn-info ms-2">
                                                    <a href="#" data-size="lg" data-url="{{ URL::to('expenses/'.$expense->id.'/edit') }}" data-ajax-popup="true" data-title="{{__('Edit Expense')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Edit Expense')}}" ><i class="ti ti-pencil text-white"></i></a>
                                                </div>
                                                @endcan
                                                @can('Delete Expense')
                                                    <div class="action-btn bg-danger ms-2">
                                                        {!! Form::open(['method' => 'DELETE', 'route' => ['expenses.destroy', $expense->id]]) !!}
                                                            <a href="#!" class="mx-3 btn btn-sm d-inline-flex align-items-center show_confirm" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Delete Expense')}}">
