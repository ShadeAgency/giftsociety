...
<div class="card-body">
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            {{ Form::text('date', null, array('class' => 'form-control d_week','required'=>'required')) }}
        </div>
        <div class="col-6 form-group">
        ...
        <div class="col-12 form-group">
            ...
            <div class="choose-files ">
                <label for="attachment">
                    <div class=" bg-primary attachment_update"> <i class="ti ti-upload px-1"></i>{{__('Select image')}}</div>
                    <input type="file" class="form-control file" name="attachment" id="attachment" data-filename="attachment_update"accept=".jpeg,.jpg,.png,.doc,.pdf">
                </label>
            </div>
        </div>
    </div>
