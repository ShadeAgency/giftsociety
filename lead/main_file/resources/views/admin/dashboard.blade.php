...
@section('content')
    ...
    <div class="row">
                            ...
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mb-3 mb-sm-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            <small class="text-muted">{{ __('Total Owner') }}</small>

                                        </div>
                                    </div>
                                </div>
                                <div class="col-auto text-end">
                                    <h4 class="m-0">{{ $arrCount['owner']['owner'] }}</h4>
                                    @if(\Auth::user()->type == 'Super Admin')
                                        <small class="text-muted"><span class="text-success">{{__('Paid Users')}} : </span> {{ number_format($arrCount['owner']['total']) }}</small>
                                    @endif
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <small class="text-muted">{{ __('Total Order') }}</small>

                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto text-end">
                                        <h4 class="m-0">{{ $arrCount['order']['order'] }}</h4>
                                        @if(\Auth::user()->type == 'Super Admin')
                                            <small class="text-muted"><span class="text-success">{{__('Total Order Amount')}} : </span> {{ number_format($arrCount['order']['total']) }}</small>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3">
                                                <small class="text-muted">{{ __('Total Plan') }}</small>

                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto text-end">
                                        <h4 class="m-0">{{ $arrCount['plan']['plan'] }}</h4>
                                        @if(\Auth::user()->type == 'Super Admin')
                                            <small class="text-muted"><span class="text-success">{{__('Most purchase plan')}} : </span> {{ ($arrCount['plan']['total']) ? $arrCount['plan']['total']->name : '-' }}</small>
                                        @endif
                                    </div>
                                </div>
                            </div>
        ...
        @if(!empty($chartData))
            ...
            <div class="{{ (\Auth::user()->type == 'Super Admin')? 'col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12' : 'col-xxl-5'}}">
