                                    ...
                                    <table class="">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if($invoice->status == 0)
                                                <td>
                                                    <span class="badge rounded p-2 px-3 bg-primary">{{ __(\App\Models\Estimation::$statues[$invoice->status]) }}</span>
                                                </td>
                                                @elseif($invoice->status == 1)
                                                <td>
                                                    <span class="badge rounded p-2 px-3 bg-danger">{{ __(\App\Models\Estimation::$statues[$invoice->status]) }}</span>
                                                </td>
                                                @elseif($invoice->status == 2)
                                                <td>
                                                    <span class="badge rounded p-2 px-3 bg-warning">{{ __(\App\Models\Estimation::$statues[$invoice->status]) }}</span>
                                                </td>
                                                @elseif($invoice->status == 3)
                                                <td>
                                                    <span class="badge rounded p-2 px-3 bg-success">{{ __(\App\Models\Estimation::$statues[$invoice->status]) }}</span>
                                                </td>
                                                @elseif($invoice->status == 4)
                                                <td>
                                                    <span class="badge rounded p-2 px-3 bg-info">{{ __(\App\Models\Estimation::$statues[$invoice->status]) }}</span>
                                                </td>
                                                @endif
                                                </div>
                                            </tr>
