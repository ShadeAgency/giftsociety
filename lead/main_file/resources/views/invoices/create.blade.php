...
<div class="modal-body">
    <div class="row">
        ...
        <div class="col-6 form-group">
            ...
            {{ Form::text('issue_date',null, array('class' => 'form-control','id'=>'data_picker1','required'=>'required')) }}
        </div>
        <div class="col-6 form-group">
            {{ Form::label('due_date', __('Due Date'),['class'=>'col-form-label']) }}
            {{ Form::text('due_date',null, array('class' => 'form-control','id'=>'data_picker2','required'=>'required')) }}
        </div>
