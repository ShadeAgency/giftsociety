                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($contract->status  == 'Start')
                                                    <span class="badge rounded p-2 badge-sm bg-primary">{{ucfirst($contract->status )}}</span>
                                                @else
                                                    <span class="badge rounded p-2 badge-sm bg-danger">{{ucfirst($contract->status )}}</span>
                                                @endif
                                            </td>
                                            <td class="Action">
                                                <span>
