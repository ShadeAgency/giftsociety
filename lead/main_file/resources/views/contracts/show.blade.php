...
@section('action-button')
        ...
        @if(\Auth::user()->type == 'Owner' && $contract->status == 'Start')
       ...
       @if(\Auth::user()->type == 'Owner' || \Auth::user()->type == 'Client')
        ...
        @if(((\Auth::user()->type =='Owner') && ($contract->owner_signature == '')||(\Auth::user()->type =='Client') && ($contract->client_signature == '') )&& ($contract->status == 'Start'))
                                    ...
                                    <div class="px-4 py-3">
                                        <div class="list-group-item ">
                                            <div class="row align-items-center">
                                                ...
                                                @if(((\Auth::user()->id == $file->user_id) || (\Auth::user()->type == 'Owner')) &&($contract->status == 'Start'))
                                        ...
                                        @endphp
                                            <div class="list-group-item ">
                                                <div class="row align-items-center">
                                                    ...
                                                    @if(((\Auth::user()->id == $comment->user_id) || (\Auth::user()->type == 'Owner')) &&($contract->status == 'Start'))
                                            ...
                                            <div class="list-group list-group-flush mb-0" id="comments">
                                                ...
                                                <div class="list-group-item ">
                                                    <div class="row align-items-center">
                                                        ...
                                                        @if(((\Auth::user()->id == $note->user_id) || (\Auth::user()->type == 'Owner')) &&($contract->status == 'Start'))
                                                        <div class="col-auto p-0 ms-2 action-btn bg-danger">
