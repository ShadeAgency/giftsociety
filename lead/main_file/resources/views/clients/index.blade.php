...
@section('action-button')
         ...
         @can('Create Client')
                <a href="#" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Client')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Client')}}" data-url="{{route('clients.create')}}"><i class="ti ti-plus text-white"></i></a>
        @endcan
