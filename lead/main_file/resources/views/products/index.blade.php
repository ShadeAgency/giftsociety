                    ...
                    <div class="table-responsive">
                        <table class="table pc-dt-simple">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="@if($product->image) {{asset(Storage::url('product/'.$product->image))}} @else {{asset('custom/img/news/img01.jpg')}} @endif" target="_blank">
                                            <img src="@if($product->image) {{asset(Storage::url('product/'.$product->image))}} @else {{asset('custom/img/news/img01.jpg')}} @endif" width="70"/></td>
                                        </a>
                                    <td>{{ $product->name }}</td>
