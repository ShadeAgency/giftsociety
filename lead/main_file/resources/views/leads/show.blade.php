                                        ...
                                        <div class="">
                                            <table class="table align-items-center mb-0">
                                                ...
                                                @foreach($lead->users as $user)
                                                    <tr>
                                                        <td>
                                                            <a @if($user->avatar) href="{{asset('/storage/avatars/'.$user->avatar)}}" @else href="{{asset('custom/img/avatar/avatar-1.png')}}" @endif target="_blnak">
                                                        ...
                                                        @if($products)
                                                            @foreach($products as $product)
                                                                <tr>
                                                                    <td>
                                                                        <a @if($product->avatar) href="{{asset('/storage/product/'.$product->avatar)}}" @else href="{{asset('custom/img/news/img01.jpg')}}" @endif target="_blank">
                                                                            <img width="50" @if($product->avatar) src="{{asset('/storage/product/'.$product->avatar)}}" @else src="{{asset('custom/img/news/img01.jpg')}}" @endif>
                                                                        </a>
                                                                    </td>
                                                                    <td>
                                                                        <span class="number-id">{{$product->name}} </span> (<span class="text-muted">{{\Auth::user()->priceFormat($product->price)}}</span>)
                                        ...
                                        @foreach($lead->discussions as $discussion)
                                            <li class="media">
                                               <div style="margin-right: 10px;">
                                                <a href="@if($discussion->user->avatar) {{asset('/storage/avatars/'.$discussion->user->avatar)}} @else {{asset('custom/img/avatar/avatar-1.png')}} @endif" target="_blank">
                                                    <img alt="image" class="rounded-circle mr-3" width="50" height="50" src="@if($discussion->user->avatar) {{asset('/storage/avatars/'.$discussion->user->avatar)}} @else {{asset('custom/img/avatar/avatar-1.png')}} @endif">
                                                </a>
                                               </div>
                                        ...
                                        <div class="card-body table-border-style bg-none height-450">
                                            <ul class="list-unstyled list-unstyled-border">
                                                @foreach($emails as $email)
                                                    <li class="media mb-3">
                                                        <div style="margin-right: 10px;">
                                                            <a href="{{asset('custom/img/avatar/avatar-1.png')}}" target="_blnak">
