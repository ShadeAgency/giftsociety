...
@push('script')
    ...
    @can("Move Lead")
        ...
        <script src="{{asset('assets/js/plugins/dragula.min.js')}}"></script>
            <!-- <script src="{{asset('custom/libs/dragula/dist/dragula.min.js')}}"></script> -->
            <script>
                !function (a) {
                    "use strict";
                    var t = function () {
    ...
    <div class="row align-items-center m-1">
        ...
        @endif
         ...
         <div class="col-auto ps-1">
            <a href="#" class="btn btn-sm btn-primary btn-icon " data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Lead')}}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Lead')}}" data-url="{{route('leads.create')}}"><i class="ti ti-plus text-white"></i></a>
        </div>
        @endcan
                                    ...
                                    @foreach($leads as $lead)
                                        <div class="card" data-id="{{$lead->id}}">
                                                ...
                                                <div class="card-header border-0 pb-0 position-relative">
                                                    <h5><a href="@can('View Lead')@if($lead->is_active){{route('leads.show',$lead->id)}}@else#@endif @else#@endcan" class="text-body">{{$lead->name}}</a></h5>
