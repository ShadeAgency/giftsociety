        ...
        <div class="col-sm-12">
                <div class="row">
                    <div class="col-xl-3">
                        <div class="card sticky-top" style="top:30px">
                            <div class="list-group list-group-flush" id="useradd-sidenav">
                                <a href="#business-setting" class="list-group-item list-group-item-action border-0">{{__('Site Setting')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#mail-setting" class="list-group-item list-group-item-action border-0">{{__('Mailer Settings')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                ...
                                <a href="#system-setting" class="list-group-item list-group-item-action border-0">{{__('System Setting')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#company-setting" class="list-group-item list-group-item-action border-0">{{__('Company Setting')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#company-payment-setting" class="list-group-item list-group-item-action border-0">{{__('Payment Settings')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#invoice-setting" class="list-group-item list-group-item-action border-0">{{__('Invoice Print Setting')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#estimation-setting" class="list-group-item list-group-item-action border-0">{{__('Estimation Print Setting')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#mdf-setting" class="list-group-item list-group-item-action border-0">{{__('MDF Print Setting')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

                                <a href="#zoom-setting" class="list-group-item list-group-item-action border-0">{{__('Zoom Setting')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                    ...
                    <div class="col-xl-9">
                                                        ...
                                                        <div class=" setting-card">
                                                            <div class="logo-content mt-4 text-center">
                                                                <a href="{{asset(Storage::url('logo/logo-dark.png'))}}" target="_blank">
                                                                    <img id="blah" alt="your image" src="{{$logo.'/'.(isset($dark_logo) && !empty($dark_logo)?$dark_logo:'logo-dark.png')}}" class="big-logo" />
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class=" setting-card">
                                                            <div class="logo-content mt-4 text-center">
                                                                <a href="{{asset(Storage::url('logo/logo-light.png'))}}" target="_blank">
                                                                    <img id="blah1" src="{{$logo.'/'.(isset($light_logo) && !empty($light_logo)?$light_logo:'logo-light.png')}}" class="big-logo img_setting" alt="your image"/>
                                                                </a>
                                                            </div>
                                                            <div class="choose-files mt-5 logo-btn">
                                                        ...
                                                        <div class=" setting-card">
                                                            <div class="logo-content mt-4 text-center">
                                                                <a href="{{asset(Storage::url('logo/favicon.png'))}}" target="_blank">
                                                                    <img id="blah2" src="{{$logo.'/'.(isset($company_favicon) && !empty($company_favicon)?$company_favicon:'favicon.png')}}" class="small-logo" style="width: 60px !important;"  alt=""/>
                                                                </a>
                                                            </div>
                                                            <div class="choose-files mt-5 logo-btn">
                                                                <label for="favicon">
                        ...
                        <div class="card" id="mail-setting">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <small>{{__('This detail will use for enable Chat')}}</small>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-end">
                        ...
                        <div id="system-setting" class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row company-setting">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 form-group">
                                        ...
                                        <div class="d-flex radio-check">
                                            <div class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <label class="custom-control-label col-form-label" for="pre">{{__('Pre')}}</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                ...
                                                <label class="custom-control-label col-form-label" for="post">{{__('Post')}}</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 form-group">
                                        <label for="invoice_prefix" class="col-form-label">{{__('Invoice Prefix')}} *</label>
                                        <input type="text" name="invoice_prefix" class="form-control" id="invoice_prefix" value="{{$settings['invoice_prefix']}}" required>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-6 form-group">
                                        <label for="contract_prefix" class="col-form-label">{{__('Contract Prefix')}}</label>
                                        <input type="text" name="contract_prefix" class="form-control" id="contract_prefix" value="{{$settings['contract_prefix']}}" required>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-6 form-group">
                                        <label for="estimation_prefix" class="col-form-label">{{__('Estimation Prefix')}} *</label>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 form-group">
                                        <label for="footer_note" class="col-form-label">{{__('Invoice/Estimation/MDF Note')}} *</label>
                                        <textarea name="footer_note" id="footer_note" class="form-control">{{$settings['footer_note']}}</textarea>
                                    </div>

                                    <div class="form-group col-md-12 text-end">
                                        <input type="submit" id="addSig" value="{{__('Save Changes')}}" class="btn btn-print-invoice  btn-primary m-r-10">
                                    </div>
                                </div>
                        ...
                        <div class="card" id="company-setting">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row company-setting">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 form-group">
                                        <label for="company_zipcode" class="col-form-label">{{__('Zip/Post Code')}}</label>
                                    ...
                                    <div class="form-group col-md-12 text-end">
                                        <input type="submit" id="save-btn" value="{{__('Save Changes')}}" class="btn btn-print-invoice  btn-primary m-r-10">
                                    </div>
                                </div>
                            </form>
                            </div>
                            ...
                            <div class="bg-none">
                                <div class="row company-setting">
                                                    ...
                                                    <label class="col-form-label">{{__('Estimation Logo')}}</label>
                                                        <div class="choose-files mt-5 ">
                                                            <label for="estimation_logo">
                                                                <div class=" bg-primary estimation_logo_update"> <i class="ti ti-upload px-1"></i>{{__('Choose file here')}}</div>
                                                                <input type="file" class="form-control file" name="estimation_logo" id="estimation_logo" data-filename="estimation_logo_update">
                                                            </label>
                                                        </div>
                                                </div>
                                                <div class="form-group mt-2 text-end">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        @else
                                            <iframe id="estimation_frame" frameborder="0" class="w-100 h-1050" src="{{route('estimations.preview',['template1','ffffff'])}}"></iframe>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row company-setting">
                                    <div class="col-md-3">
                                        <div class="card-header card-body">
                                            <form id="setting-form" method="post" action="{{route('template.setting')}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="address" class="col-form-label">{{__('MDF Template')}}</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="choose-files mt-5 ">
                                                        <label for="mdf_logo">
                                                            <div class=" bg-primary mdf_logo_update"> <i class="ti ti-upload px-1"></i>{{__('Choose file here')}}</div>
                                                            <input type="file" class="form-control file" name="mdf_logo" id="mdf_logo" data-filename="mdf_logo_update">
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group mt-2 text-end">
                                    ...
                                    <div class="col-md-9">
                                        @if(isset($settings['mdf_template']) && isset($settings['mdf_color']))
                                            <iframe id="mdf_frame" class="w-100 h-1050" frameborder="0" src="{{route('mdf.preview',[$settings['mdf_template'],$settings['mdf_color']])}}"></iframe>
                                        @else
                                            <iframe id="mdf_frame" class="w-100 h-1050" frameborder="0" src="{{route('mdf.preview',['template1','ffffff'])}}"></iframe>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card" id="zoom-setting">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <form id="setting-form" method="post" action="{{route('setting.ZoomSettings')}}">
                                            @csrf
                                            <div class="bg-none">
                                                <div class="row company-setting">
                                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                        <label for="site_currency_symbol" class="col-form-label">{{__('Zoom Secrate Key')}}</label>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="form-check form-switch d-inline-block float-right">
                                                    {{Form::checkbox('estimate_notification', '1',isset($settings['estimate_notification']) && $settings['estimate_notification'] == '1' ?'checked':'',array('class'=>'form-check-input','id'=>'estimate_notification'))}}
                                    ...
                                    <div class="col-md-4">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="form-check form-switch d-inline-block float-right">
                                                    {{Form::checkbox('invoice_status_update_notification', '1',isset($settings['invoice_status_update_notification']) && $settings['invoice_status_update_notification'] == '1' ?'checked':'',array('class'=>'form-check-input','id'=>'invoice_status_update_notification'))}}
                                                    <label class="form-check-label" for="invoice_status_update_notification"></label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="row">
                                     <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <small  >{{__('Get Chat ID')}} : https://api.telegram.org/bot-TOKEN-/getUpdates</small>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item d-flex align-items-center justify-content-between">
                                                <span> {{__('Estimate create')}}</span>
                                                <div class="form-check form-switch d-inline-block float-right">
                                                    {{Form::checkbox('telegram_estimate_notification', '1',isset($settings['telegram_estimate_notification']) && $settings['telegram_estimate_notification'] == '1' ?'checked':'',array('class'=>'form-check-input','id'=>'telegram_estimate_notification'))}}
                                                    <label class="form-check-label" for="telegram_estimate_notification"></label>
                                                </div>
                                            </li>  
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item d-flex align-items-center justify-content-between">
                                                <span>{{__('Invoice status updated')}}</span>
                                                <div class="form-check form-switch d-inline-block float-right">
                                                    {{Form::checkbox('telegram_invoice_status_update_notification', '1',isset($settings['telegram_invoice_status_update_notification']) && $settings['telegram_invoice_status_update_notification'] == '1' ?'checked':'',array('class'=>'form-check-input','id'=>'telegram_invoice_status_update_notification'))}}
                                                    <label class="form-check-label" for="telegram_invoice_status_update_notification"></label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                @foreach ($EmailTemplates as $EmailTemplate)
                                    <div class="col-md-4">
                                        ...
                                        <li class="list-group-item d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="form-check form-switch d-inline-block float-right">
                                                <input type="checkbox" class="form-check-input email-template-checkbox" id="email_tempalte_{{$EmailTemplate->template->id}}" @if($EmailTemplate->template->is_active == 1) checked="checked" @endcan type="checkbox" value="{{$EmailTemplate->template->is_active}}" data-url="{{route('status.email.language',[$EmailTemplate->template->id])}}"/>
                                                <label class="form-check-label" for="lead_notification"></label>
                                            </div>
                                        </li>
                                        @endcan
