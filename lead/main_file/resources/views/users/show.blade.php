                               ...
                               @foreach ($deals as $deal)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a @if($user->avatar) href="{{asset('/storage/avatars/'.$user->avatar)}}" @else href="{{asset('custom/img/avatar/avatar-1.png')}}" @endif  class="btn btn-sm mr-1 p-0 rounded-circle" target="_blank">
