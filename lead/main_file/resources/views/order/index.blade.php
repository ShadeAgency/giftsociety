                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($order->payment_status == 'succeeded')
                                            <span class="badge rounded p-2 px-3 bg-success">{{ucfirst($order->payment_status)}}</span>
                                        @else
                                            <span class="badge rounded p-2 px-3 bg-danger">{{ucfirst($order->payment_status)}}</span>
                                        @endif
                                    </td>
