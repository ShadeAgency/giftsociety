                                            ...
                                            <table class="table align-items-center mb-0">
                                                <tbody class="list">
                                                    @foreach($deal->users as $user)
                                                        <tr>
                                                            <td>
                                                                <a @if($user->avatar) href="{{asset('/storage/avatars/'.$user->avatar)}}" @else href="{{asset('custom/img/avatar/avatar-1.png')}}" @endif target="_blank">
                                                                    <img @if($user->avatar) src="{{asset('/storage/avatars/'.$user->avatar)}}" @else src="{{asset('custom/img/avatar/avatar-1.png')}}" @endif width="30" class="avatar-sm rounded-circle">
                                                                </a>
                                                            </td>
                                                            <td>
                                                ...
                                                <tbody class="list">
                                                    ...
                                                    @if($products)
                                                        @foreach($products as $product)
                                                            <tr>
                                                                <td>
                                                                    <a @if($product->avatar) href="{{asset('/storage/product/'.$product->avatar)}}" @else href="{{asset('custom/img/news/img01.jpg')}}" @endif target="_blank">
                                                                        <img width="30" @if($product->avatar) src="{{asset('/storage/product/'.$product->avatar)}}" @else src="{{asset('custom/img/news/img01.jpg')}}" @endif>
                                                                    </a>
                                                                </td>
                                                                <td>
                                        ...
                                        @foreach($deal->discussions as $discussion)
                                            <li class="media">
                                                <div style="margin-right: 10px;">
                                                    <a href="@if($discussion->user->avatar) {{asset('/storage/avatars/'.$discussion->user->avatar)}} @else {{asset('custom/img/avatar/avatar-1.png')}} @endif" target="_blank"></a>
                                                    <img alt="image" class="mr-3 rounded-circle" width="50" height="50" src="@if($discussion->user->avatar) {{asset('/storage/avatars/'.$discussion->user->avatar)}} @else {{asset('custom/img/avatar/avatar-1.png')}} @endif">
                                                </div>
                                            ...
                                            <table class="table mb-0 pc-dt-simple">
                                                ...
                                                <tbody>
                                                    @foreach ($deal->clients as $client)
                                                        <tr>
                                                            <td>
                                                                <a href="@if($client->avatar) {{asset('/storage/avatars/'.$client->avatar)}} @else {{asset('custom/img/avatar/avatar-1.png')}} @endif" target="_blnak">
                                                                    <img src="@if($client->avatar) {{asset('/storage/avatars/'.$client->avatar)}} @else {{asset('custom/img/avatar/avatar-1.png')}} @endif" class="rounded-circle mr-1" width="50"></td>
                                                                </a>
                                                            <td>{{ $client->name }}</td>
                                                            <td>{{ $client->email }}</td>
                                                            <td class="text-end">
