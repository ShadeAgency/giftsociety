...
<head>
   ...
   <title><?php echo e((Utility::getValByName('header_text')) ? Utility::getValByName('header_text') : config('app.name', 'LeadGo')); ?> &dash; <?php echo $__env->yieldContent('title'); ?></title>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e(asset(Storage::url('logo/favicon.png'))); ?>" type="image/x-icon" />
...
</html><?php /**PATH /home/shadecrm/giftsociety.shadecrm.com/lead/main_file/resources/views/layouts/auth.blade.php ENDPATH**/ ?>