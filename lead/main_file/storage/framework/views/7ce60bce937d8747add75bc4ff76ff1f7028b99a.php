...
<html lang="en" dir="<?php echo e($SITE_RTL == 'on'?'rtl':''); ?>">
  <head>
    ...
    <title><?php echo e((Utility::getValByName('header_text')) ? Utility::getValByName('header_text') : config('app.name', 'LeadGo')); ?></title>
    <meta charset="utf-8" />
    <meta
      name="viewport"
 ...
 <!--    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css')); ?>" id="main-style-link"> -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('custom/css/landing.css')); ?>" />
  </head>
  ...
  <body class="<?php echo e($color); ?>">
        ...
        <div class="row align-items-center justify-content-between">
          <div class="col-sm-5">
            ...
            <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
              ...
              >
              <a href="https://codecanyon.net/item/leadgo-lead-management-tool/25249054" class="btn btn-outline-light"
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
      <div class="container">
        ...
        <div class="row align-items-center justify-content-center mobile-screen">
          <div class="col-auto">
            <div class="wow animate__fadeInRight mobile-widget" data-wow-delay="0.2s">
              ...
              alt="<?php echo e(config('app.name', 'LeadGo')); ?>" class="logo logo-lg">
            </div>
          </div>
          <div class="col-auto">
        ...
        <img
          src="<?php echo e(asset('landing/img-dashboard.png')); ?>"
          alt=""
        ...
        <div class="row align-items-center justify-content-end mb-5">
          <div class="col-sm-4">
            ...
            <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
              All in one place <br />LeadGo system
            </h2>
            <p class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.6s">
              Use these awesome forms to login or create new account in your
              project for free.
          ...
          <div class="col-sm-6">
            <img
              src="<?php echo e(asset('landing/tab1.png')); ?>"
              alt="Datta Able Admin Template"
              class="img-fluid header-img wow animate__fadeInRight"
              data-wow-delay="0.2s"
            />
    ...
    <section id="feature" class="feature">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-6 col-md-9 title">
            <h2>
              <span class="d-block mb-3">Features</span> All in one place LeadGo
              system
            </h2>
            <p class="m-0">
              Use these awesome forms to login or create new account in your
    ...
    <section class="">
      <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
          ...
          <div class="col-sm-6">
            <img
              src="<?php echo e(asset('landing/img-crm-dash-3.svg')); ?>"
              alt="Datta Able Admin Template"
              class="img-fluid header-img wow animate__fadeInRight"
              data-wow-delay="0.2s"
            />
        ...
        <div class="row align-items-center">
          ...
          <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
            <div class="row feature-img-row m-auto">
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/tab2.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight mt-5"
                  data-wow-delay="0.4s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/tab3.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight mt-5"
                  data-wow-delay="0.6s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/tab4.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight mt-5"
                  data-wow-delay="0.8s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/tab5.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight mt-5"
                  data-wow-delay="0.3s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/tab6.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight mt-5"
                  data-wow-delay="0.5s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/tab7.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight mt-5"
                  data-wow-delay="0.7s"
                  alt="Admin"
                />
              ...
              <div class="col-lg-3 col-sm-6">
                <img
                  src="<?php echo e(asset('landing/tab8.png')); ?>"
                  class="img-fluid header-img wow animate__fadeInRight mt-5"
                  data-wow-delay="0.9s"
                  alt="Admin"
                />
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 col-sm-12 text-end">
            ...
            <p class="text-body"> <?php echo e(__('Copyright')); ?> &copy; <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :config('app.name', 'LeadGo')); ?> <?php echo e(date('Y')); ?>  </p>
          </div>
        </div>
      </div>
    </section>
...
<?php /**PATH /home/shadecrm/giftsociety.shadecrm.com/lead/main_file/resources/views/layouts/landing.blade.php ENDPATH**/ ?>