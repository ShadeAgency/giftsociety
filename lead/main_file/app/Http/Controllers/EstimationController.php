...
class EstimationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($usr->can('Create Estimation'))
        {
            ...
            $estimation->created_by    = $usr->ownerId();
            $estimation->save();
            ...
            /*ActivityLog::create(
                [
                    ...
                    'log_type' => 'Create Estimation',
                    'remark' => sprintf(__('%s Create new estimation "%s"'), $usr->name, $usr->estimateNumberFormat($estimation->estimation_id)),
                ]
            );*/
