...
class StageController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('Create Stage'))
        {
            ...
            return redirect()->route('stages.index')->with('success', __('Stage successfully created!'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission Denied.'));
    ...
    public function update(Request $request, Stage $stage)
    {
        if(\Auth::user()->can('Edit Stage'))
        {
            ...
            if($stage->created_by == \Auth::user()->ownerId())
            {
                ...
                return redirect()->route('stages.index')->with('success', __('Stage successfully updated!'));
            }
            else
            {
                return redirect()->back()->with('error', __('Permission Denied.'));
