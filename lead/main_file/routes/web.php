...
Route::get('estimations/{id}/get_estimation', 'EstimationController@printEstimation')->name('get.estimation');
Route::get('/estimations/preview/{template}/{color}',['as' => 'estimations.preview','uses' =>'EstimationController@previewEstimation']);
Route::get(
    '/estimation/pay/{estimation}', [
           'as' => 'pay.estimation',
           'uses' => 'EstimationController@payestimation',
       ]
);

 Route::get('estimation/pay/pdf/{id}', 'EstimationController@pdffromestimation')->name('estimation.download.pdf');
...
Route::get('emailtemplate_lang/{id}/{lang?}', 'EmailTemplateController@manageEmailLangindex')->name('manageemail.lang')->middleware(['auth','XSS']);
...
Route::post('/contract/copy/store',['as' => 'contracts.copy.store','uses' =>'ContractController@copycontractstore'])->middleware(['auth','XSS']);
...
Route::post('/invoices/{id}/payment',['as' => 'client.invoice.payment','uses' =>'InvoiceController@addPayment'])->middleware( 'XSS');
...
Route::get('/invoice/mercado/{invoice}', ['as' => 'invoice.mercado','uses' => 'MercadoPaymentController@getInvociePaymentStatus']);
...
Route::get('/invoice/error/{flag}/{invoice_id}', ['as' => 'error.invoice.show','uses' => 'PaymentWallController@invoiceerror']);
Route::post('/invoicepayment',['as' => 'paymentwall.invoice','uses'=>'PaymentWallController@invoicepay']);
Route::post('/invoice-pay-with-paymentwall/{invoice}',['as' => 'invoice-pay-with-paymentwall','uses' =>'PaymentWallController@invoicePayWithPaymentWall']);
...
// ======================================Import/Export===============================================
Route::get('client/import/export', 'ClientController@fileImportExport')->name('client.file.import');
Route::post('client/import', 'ClientController@fileImport')->name('client.import');
Route::get('client/export', 'ClientController@fileExport')->name('client.export');

Route::get('invoice/export', 'InvoiceController@fileExport')->name('invoice.export');

Route::get('estimation/export', 'EstimationController@fileExport')->name('estimation.export');
...
//=======================================zoom=================================
Route::post('/setting/saveZoomSettings', ['as' => 'setting.ZoomSettings','uses' => 'SettingsController@saveZoomSettings'])->middleware(['auth','XSS']);

Route::any('zoommeeting/calendar', 'ZoomMeetingController@calender')->name('zoommeeting.calender')->middleware(['auth','XSS']);
